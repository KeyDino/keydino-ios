...
class TransactionDetailsViewController : UICollectionViewController, Subscriber {
    ...
    fileprivate var isBchSwapped: Bool
...
extension TransactionDetailsViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        transactionDetailCell.set(transaction: transactions[indexPath.row], isBchSwapped: isBchSwapped, rate: rate, rates: store.state.rates, maxDigits: store.state.maxDigits)
