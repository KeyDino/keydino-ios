...
class Sender {
    ...
    private func postProtocolPaymentIfNeeded() {
        ...
        request.setValue("application/bitcoincash-payment", forHTTPHeaderField: "Content-Type")
        request.addValue("application/bitcoincash-paymentack", forHTTPHeaderField: "Accept")
        ...
        URLSession.shared.dataTask(with: request as URLRequest) { data, response, error in
            ...
            if response.mimeType == "application/bitcoincash-paymentack" && data.count <= 50000 {
